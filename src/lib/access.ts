 ...
 *
 * Only the production report, the budget follow-up and the OT report are in
 * use; the rest are shut
...
/** The API routes those pages call. Everything else under /api is closed. */
